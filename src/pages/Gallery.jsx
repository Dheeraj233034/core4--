...
//         <div className="inline-block text-blue-600 px-4 py-1 rounded-md text-4xl font-bold">
//           Gallery
//         </div>
...
//             {/* Caption on Hover */}
//             <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-70 text-white text-center p-2 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out">
//               {image.caption}
//             </div>
//           </div>
//         ))}
...
//         >
//           <div className="relative p-4" data-aos="fade-in">
//             <button
